  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center">
      <div className="sm:w-3/5">
        <h1 className="text-2xl pb-1">Register a Discord webhook</h1>
        <ol className="list-decimal pl-6 pb-2">
          ...
          <li>
            Paste the webhook below and click <b>Register webhook</b>.
          </li>
          <li>
            See{" "}
            <Link
            ...
            Discord support article for more information.
          </li>
        </ol>
        <p className="pb-2">
          ...
          just delete the webhook in the Discord app.
        </p>
